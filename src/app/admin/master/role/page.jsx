// server component
import categories from "../../../../data/role";
    ...
    <div className="space-y-4">{/* slightly tighter vertical rhythm */}
      ...
      <section className="bg-white rounded-xl shadow-sm px-5 py-3">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-[18px] font-semibold">Role</h2>
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="h-9 px-4 rounded-md bg-blue-600 text-white text-[13px] hover:bg-blue-700">Add New Category</button>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white rounded-xl shadow-sm px-5 py-4">
        <div className="flex items-center justify-between mb-2">
          <h3 className="text-[16px] font-semibold">Role List</h3>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-[13px] leading-tight">
            <thead className="text-slate-600">
              <tr>
                <th className="text-left font-medium py-2.5 pr-3">Role</th>
            ...
            <tbody>
              {categories.map((c, i) => (
                <tr key={i} className="border-b border-slate-200 last:border-0">
                  <td className="py-2.5 pr-3">{c.role}</td>
